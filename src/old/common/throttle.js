...
* @param { function } 需要调用的函数
* @param { number } 延迟时间，单位毫秒
* @param { boolean } 给immediate参数传递false 绑定的函数先执行，而不是delay后后执行
* @param { boolean } 是否流式执行
...
* @param { number } 空闲时间
* @param { boolean } 给 immediate参数传递false 绑定的函数先执行，而不是delay后后执行
* @return { function } 实际调用函数
*/
